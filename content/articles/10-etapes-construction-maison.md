...
Avant toute chose, il vous faut un terrain avec un **titre foncier** (TF) ou un **bail** en règle. C'est la base de tout projet de construction.
...
Au Sénégal, **le recours à un architecte est obligatoire** pour tout projet de construction dont le budget dépasse **30 millions FCFA** (décret d'application de la loi sur l'architecture).
...
| Second œuvre | 2 à 3 mois |
| Finitions | 1 à 2 mois |
| **Total** | **8 à 12 mois** |

> **Conseil crucial** : commencez les travaux en **novembre ou décembre** pour profiter de toute la saison sèche (novembre à mai). Cela permet de réaliser le gros œuvre dans les meilleures conditions.
