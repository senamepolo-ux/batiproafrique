...
**Phase 2 (quand vous avez plus de moyens)** : finition des autres pièces, enduits extérieurs, carrelage
...
Voici un plan réaliste pour une maison de 60 m² (2 chambres) avec 5 millions FCFA :
...
| Structure béton armé (poteaux + poutres + chaînages) | 1 200 000 FCFA |
| Murs en BTC | 400 000 FCFA |
| Toiture (charpente métallique + tôle) | 900 000 FCFA |
| Plomberie | 250 000 FCFA |
| Électricité | 300 000 FCFA |
...
- Maison de 60 m² avec structure complète en béton armé
- 2 chambres + salon + cuisine + salle d'eau
- Toiture en tôle sur charpente métallique
- Murs en BTC (apparente à l'intérieur, enduit ciment à l'extérieur)
- Sol en ciment lissé (carrelage plus tard)
- Électricité et plomberie fonctionnelles
- Portes et fenêtres en fer forgé

### Ce qui reste à faire plus tard (phase 2)
